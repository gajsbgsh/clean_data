...
# 获取用户输入的 prompt 和示例
default_text =  "例如：以下内容是用户对使用微信的问题反馈"
user_prompt = st.text_input("请概括一下你要分析的文本的内容：",default_text)
user_examples = st.text_area("请输入分类示例（每行一句，可以给3个示例。格式：要分析的内容，分类）：", height=200)
